...
class RuleFindingCode(StrEnum):
    ...
    RULE_EXTRACTION_PRIVACY_BLOCKED = "RULE_EXTRACTION_PRIVACY_BLOCKED"
    ...
    # -- MT semantic references --------------------------------------------------------
    MT_RULE_MESSAGE_NOT_FOUND = "MT_RULE_MESSAGE_NOT_FOUND"
    MT_RULE_SRU_MISMATCH = "MT_RULE_SRU_MISMATCH"
    MT_RULE_SEQUENCE_NOT_FOUND = "MT_RULE_SEQUENCE_NOT_FOUND"
    MT_RULE_FIELD_NOT_FOUND = "MT_RULE_FIELD_NOT_FOUND"
    MT_RULE_OPTION_NOT_RESOLVED = "MT_RULE_OPTION_NOT_RESOLVED"
    MT_RULE_QUALIFIER_NOT_RESOLVED = "MT_RULE_QUALIFIER_NOT_RESOLVED"
    MT_RULE_COMPONENT_NOT_FOUND = "MT_RULE_COMPONENT_NOT_FOUND"
    MT_RULE_REFERENCE_AMBIGUOUS = "MT_RULE_REFERENCE_AMBIGUOUS"
