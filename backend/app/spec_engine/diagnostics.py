...
class FindingCode(StrEnum):
    ...
    ISO_BUNDLE_DOWNLOAD_FAILED = "ISO_BUNDLE_DOWNLOAD_FAILED"
    ISO_BUNDLE_OVERSIZED = "ISO_BUNDLE_OVERSIZED"
    ISO_BUNDLE_PATH_TRAVERSAL = "ISO_BUNDLE_PATH_TRAVERSAL"
    ISO_BUNDLE_SYMLINK_REJECTED = "ISO_BUNDLE_SYMLINK_REJECTED"
    ISO_BUNDLE_ZIP_BOMB = "ISO_BUNDLE_ZIP_BOMB"
    ISO_BUNDLE_DUPLICATE_ENTRY = "ISO_BUNDLE_DUPLICATE_ENTRY"
    ISO_BUNDLE_NESTED_ARCHIVE_REJECTED = "ISO_BUNDLE_NESTED_ARCHIVE_REJECTED"
    ISO_BUNDLE_BAD_XSD = "ISO_BUNDLE_BAD_XSD"
    ISO_BUNDLE_NO_XSD_FOUND = "ISO_BUNDLE_NO_XSD_FOUND"
    ISO_BUNDLE_MESSAGE_NOT_FOUND = "ISO_BUNDLE_MESSAGE_NOT_FOUND"
